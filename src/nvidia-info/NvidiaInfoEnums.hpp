...
NLOHMANN_JSON_SERIALIZE_ENUM(
    MemoryType,
    {
        ...
        {MemoryType::DDR4E_SDRAM, "DDR4E-SDRAM"},
        {MemoryType::DDR5, "DDR5"},
        {MemoryType::LPDDR5_SDRAM, "LPDDR5-SDRAM"},
        {MemoryType::LPDDR4_SDRAM, "LPDDR4-SDRAM"},
        {MemoryType::LPDDR3_SDRAM, "LPDDR3-SDRAM"},
        {MemoryType::DDR2_SDRAM_FB_DIMM, "DDR2-SDRAM-FB-DIMM"},
        {MemoryType::DDR2_SDRAM_FB_DIMM_PROBE, "DDR2-SDRAM-FB-DIMM-PROBE"},
        {MemoryType::DDR_SGRAM, "DDR-SGRAM"},
        {MemoryType::ROM, "ROM"},
